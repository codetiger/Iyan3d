...
Texture* SceneManager::createRenderTargetTexture(string textureName, TEXTURE_DATA_FORMAT format, TEXTURE_DATA_TYPE texelType, int width, int height, int storageMode) {
    textures.push_back(renderMan->createRenderTargetTexture(textureName, format, texelType, width, height, storageMode));
