...
#define _IRR_COMPILE_WITH_SGM_LOADER_
#ifdef NO_IRR_COMPILE_WITH_SGM_LOADER_
#undef _IRR_COMPILE_WITH_SGM_LOADER_
#endif

#define _IRR_COMPILE_WITH_SGR_LOADER_
#ifdef NO_IRR_COMPILE_WITH_SGR_LOADER_
#undef _IRR_COMPILE_WITH_SGR_LOADER_
#endif

#define _IRR_COMPILE_WITH_SGP_LOADER_
#ifdef NO_IRR_COMPILE_WITH_SGP_LOADER_
#undef _IRR_COMPILE_WITH_SGP_LOADER_
#endif
