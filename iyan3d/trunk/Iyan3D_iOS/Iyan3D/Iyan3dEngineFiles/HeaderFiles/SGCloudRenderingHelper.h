...
public:
    ...
    static bool writeFrameData(SGAnimationScene *scene , int frameId);
    ...
    void calculateJointTransforms(vertexDataHeavy *vertex , float * jointTransforms , Vector3 &position , Vector3 &normal);
