...
static const NSString* NEWS_FEED_TABLE = @"news_feed";
static const NSString* FEED_ID = @"id";
static const NSString* FEED_TYPE = @"type";
static const NSString* FEED_URL = @"url";
static const NSString* FEED_THUMB_URL = @"thumb_url";
static const NSString* FEED_TITLE = @"title";
static const NSString* FEED_MESSAGE = @"message";
static const NSString* FEED_ISREAD = @"isread";
