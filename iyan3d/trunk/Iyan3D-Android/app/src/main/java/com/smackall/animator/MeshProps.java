...
public class MeshProps  implements View.OnClickListener , SeekBar.OnSeekBarChangeListener,RadioButton.OnCheckedChangeListener{
    ...
    public void showMeshProps(View v,MotionEvent event)
    {
        ...
        switch (UIHelper.ScreenType){
            case Constants.SCREEN_NORMAL:
                mesh_prop.getWindow().setLayout(Constants.width, (int) (Constants.height));
                break;
            default:
    ...
    private void initViews(final Dialog mesh_prop)
    {
        ...
        ((LinearLayout)mesh_prop.findViewById(R.id.hqInform1)).setOnClickListener(this);
        ((LinearLayout)mesh_prop.findViewById(R.id.hqInform2)).setOnClickListener(this);
        ...
        ((Button)mesh_prop.findViewById(R.id.setDirection_btn)).setOnClickListener(this);
    ...
    private void setDefaultValues(Dialog mesh_prop)
    {
        ...
        physicsType = (GL2JNILib.isPhysicsEnabled(selectedNodeId)) ? GL2JNILib.physicsType(selectedNodeId) : Constants.NONE;
        ...
        if(!canApplyPhysics){
            ((RadioButton)mesh_prop.findViewById(R.id.physics_none)).setEnabled(false);
            ((RadioButton)mesh_prop.findViewById(R.id.physics_static)).setEnabled(false);
            ((RadioButton)mesh_prop.findViewById(R.id.physics_light)).setEnabled(false);
            ((RadioButton)mesh_prop.findViewById(R.id.physics_medium)).setEnabled(false);
            ((RadioButton)mesh_prop.findViewById(R.id.physics_heavy)).setEnabled(false);
            ((SeekBar)mesh_prop.findViewById(R.id.velocity)).setEnabled(false);
            ((RadioGroup)mesh_prop.findViewById(R.id.physics_segment_group)).setEnabled(false);
            ((SeekBar)mesh_prop.findViewById(R.id.velocity)).setEnabled(false);
            ((Button)mesh_prop.findViewById(R.id.setDirection_btn)).setEnabled(false);
        }
    }
