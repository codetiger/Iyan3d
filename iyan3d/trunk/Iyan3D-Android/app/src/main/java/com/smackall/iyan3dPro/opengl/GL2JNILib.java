package com.smackall.iyan3dPro.opengl;
...
public class GL2JNILib {
    ...
    public static native int getMaxJoint();

    public static native int[] init(int width, int height, boolean addVAOSupport, int uniformValue, int maxJoints);
    ...
    public static native boolean save(NativeCallBacks nativeCallBacks, boolean forCloudRendering, String filepath, boolean isAutoSave);
    ...
    public static native void importModel(NativeCallBacks nativeCallBacks,String name, String filePth, String fileLocation, boolean hasMeshColor, float x, float y, float z, int assetAddType, boolean isTempNode);
    ...
    public static native void changeTexture(int selectedNodeId, int selectedMeshBufferId, String textureName, float x, float y, float z, boolean isTemp, int index);
    ...
    public static native void getNodePropsMapWithNodeId(NativeCallBacks callBacks, int nodeId);

    public static native void getSceneProps(NativeCallBacks callBacks);

    public static native void changedPropertyAtIndex(NativeCallBacks callback,int index, float x,float y,float z,float w, boolean status);

    public static native void applyPhysicsProps(NativeCallBacks callback, int index, float x, float y, float z, float w, boolean status);

    public static native void setEnvironmentTexture(String texturePath, boolean isTemp);
