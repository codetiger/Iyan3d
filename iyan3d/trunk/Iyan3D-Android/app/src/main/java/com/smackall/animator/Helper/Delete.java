...
public class Delete {
    ...
    public void showDelete()
    {
        ...
        ((Button) dialog.findViewById(R.id.deleteObj)).setVisibility((GL2JNILib.getSelectedNodeId() < 2) ? View.GONE : View.VISIBLE);
        ...
        deleteObj.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((EditorView)((Activity)mContext)).renderManager.removeObject(GL2JNILib.getSelectedNodeId(),false);
                builder.cancel();
            }
        });
        ...
        deleteAnim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!GL2JNILib.deleteAnimation()){
                    UIHelper.informDialog(mContext,"There is no animation in this frame.");
                }
                builder.cancel();
            }
        });
