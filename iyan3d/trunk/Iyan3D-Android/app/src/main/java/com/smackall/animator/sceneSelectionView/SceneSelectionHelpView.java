 ...
 */
public class SceneSelectionHelpView extends Activity {
    ...
    @Override
        protected void onCreate(Bundle savedInstanceState)
        {
            ...
            Constant.FullScreencall(SceneSelectionHelpView.this,this);
            ...
            mGallery.setAdapter(new ImageAdapterForHelpView(this, "common"));
            ...
            scene_selection_view_done_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    SceneSelectionHelpView.this.finish();
                }
            });
