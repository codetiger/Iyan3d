...
import com.smackall.iyan3dPro.Helper.LicenceCheck.util.Base64;
import com.smackall.iyan3dPro.Helper.LicenceCheck.util.Base64DecoderException;
...
class LicenseValidator {
    ...
    public void verify(PublicKey publicKey, int responseCode, String signedData, String signature) {
        ...
        if (responseCode == 0x0 || responseCode == 0x1 ||
                responseCode == 0x2) {
            // Verify signature.
            try {
        ...
        if (responseCode == 0x0 || responseCode == 0x2) {
            int limiterResponse = mDeviceLimiter.isDeviceAllowed(userId);
            handleResponse(limiterResponse, data);
        } else if (responseCode == 0x1) {
