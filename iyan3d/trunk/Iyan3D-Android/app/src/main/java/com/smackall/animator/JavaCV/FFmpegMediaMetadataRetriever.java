...
package com.smackall.animator.JavaCV;
...
public class FFmpegMediaMetadataRetriever
{
    ...
    static {
    	...
    	for (int i = 0; i < JNI_LIBRARIES.length; i++) {
    		System.load(LIBRARY_PATH+"com.smackall.animator/lib/" + JNI_LIBRARIES[i]);
    	}
    ...
    public native void lsetup();
    public static native void linit();

    private native final void lfinalize();
