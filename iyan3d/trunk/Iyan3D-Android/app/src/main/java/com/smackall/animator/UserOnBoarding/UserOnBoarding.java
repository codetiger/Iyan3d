...
public class UserOnBoarding extends FragmentActivity implements View.OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.more_info:
                ...
                try {
                    ...
                    UIHelper.informDialog(this, getString(R.string.browser_not_found));
                }
                finish();
                showHelpTip();
                break;
    ...
    public void updateUI(int position) {
        ...
        ((TextView) findViewById(R.id.next_btn_text)).setText(getResources().getString(R.string.next));
        ...
        switch (position) {
            ...
            case 4:
                ...
                ((TextView) findViewById(R.id.next_btn_text)).setText(getResources().getString(R.string.done));
