...
public class FollowApp implements View.OnClickListener{
    ...
    public void showFollowOption()
    {
        ...
        switch (UIHelper.ScreenType){
            case Constants.SCREEN_NORMAL:
                follow.getWindow().setLayout((int) (Constants.width / 2), (int) (Constants.height/1.1));
                break;
            default:
                follow.getWindow().setLayout(Constants.width / 3, (int) (Constants.height / 2));
                break;
        }
        this.follow = follow;
        initView(follow);
    ...
    {
        ((ImageView)follow.findViewById(R.id.facebook_follow)).setOnClickListener(this);
        ((ImageView)follow.findViewById(R.id.twitter_follow)).setOnClickListener(this);
        ((ImageView)follow.findViewById(R.id.google_follow)).setOnClickListener(this);
        ((ImageView)follow.findViewById(R.id.youtube_follow)).setOnClickListener(this);
    }

    public void getOpenFacebookIntent(Context context) {
        try {
            context.getPackageManager().getPackageInfo("com.facebook.katana", 0);
            ((Activity)mContext).startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("fb://page/419066601594961")));
        } catch (Exception e) {
            ((Activity)mContext).startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/iyan3d")));
        }
    }
    ...
    public void getOpenTwitterIntent(Context context) {
        try {
            ...
            ((Activity)mContext).startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("twitter://user?user_id=114656838")));
        } catch (Exception e) {
            ((Activity)mContext).startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://twitter.com/SmackallGames")));
        }
    }
    public void getOpenGooglePlusIntent(Context context){
        try {
            ...
            ((Activity)mContext).startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://plus.google.com/communities/108544248627724394883")));
        }
    }
    ...
    public void getOpenYoutubeIntent(Context context){
        try {
            ...
            ((Activity)mContext).startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/user/SmackallGames")));
        }
    }
