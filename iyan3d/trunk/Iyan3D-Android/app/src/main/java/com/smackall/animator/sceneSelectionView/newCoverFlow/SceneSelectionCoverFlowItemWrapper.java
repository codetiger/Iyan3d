...
class SceneSelectionCoverFlowItemWrapper extends ViewGroup {
    ...
    public SceneSelectionCoverFlowItemWrapper(Context context) {
        super(context);
        this.init();
    }

    public SceneSelectionCoverFlowItemWrapper(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init();
    }

    public SceneSelectionCoverFlowItemWrapper(Context context, AttributeSet attrs, int defStyle) {
