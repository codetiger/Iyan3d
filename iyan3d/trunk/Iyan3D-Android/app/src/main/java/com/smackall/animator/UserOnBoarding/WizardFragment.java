...
public class WizardFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater,
		...
		case 1:
			...
			((TextView)view.findViewById(R.id.onBoard_description)).setText(String.format(Locale.getDefault(),"%s","Add characters, environment, props \n from our library of over 300 assets or \n import an OBJ file from an external source."));
			break;
		case 2:
			view = inflater.inflate(R.layout.page2, container, false);
			...
			((TextView)view.findViewById(R.id.onBoard_description)).setText(String.format(Locale.getDefault(),"%s","Bring your character to life with our\n pre-defined motions, apply physics simulation or make one of your own actions."));
			break;
		case 3:
			view = inflater.inflate(R.layout.page2, container, false);
			...
			((TextView)view.findViewById(R.id.onBoard_description)).setText(String.format(Locale.getDefault(),"%s","Render the final video with the \n desired quality and style."));
			break;
		case 4:
			view = inflater.inflate(R.layout.page2, container, false);
			...
			((TextView)view.findViewById(R.id.onBoard_description)).setText(String.format(Locale.getDefault(),"%s","That's it. Send your 3D movie and \n showoff your skills to your friends."));
			break;
		}
		return view;
	}
