...
#define FFMPEG_CONFIGURATION "--disable-everything --disable-logging --prefix=/storage/Sabish/Iyan3D_6.0_SVN/Iyan3D/app/ffmpeg/install/x86 --enable-static --enable-shared --enable-small --disable-swscale-alpha --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --disable-swresample --disable-pthreads --disable-w32threads --disable-os2threads --disable-network --disable-dct --disable-dwt --disable-lsp --disable-lzo --disable-mdct --disable-rdft --disable-fft --disable-faan --disable-pixelutils --enable-encoder=mpeg4 --enable-decoder=png --enable-muxer=mp4 --enable-demuxer=image2 --enable-parser=png --enable-protocol=file --enable-filter=format --enable-filter=null --enable-filter=scale --enable-filter=setpts --disable-debug --enable-symver --arch=x86 --cross-prefix=/storage/android-developer/Android/Sdk/ndk-bundle/toolchains/x86-4.9/prebuilt/linux-x86_64/bin/i686-linux-android- --sysroot=/storage/android-developer/Android/Sdk/ndk-bundle/platforms/android-14/arch-x86/ --target-os=linux --extra-cflags='-Os -ffunction-sections -fdata-sections -march=i686 -mtune=intel -mssse3 -mfpmath=sse -m32' --extra-ldflags='-Wl,--gc-sections,--icf=safe ' --enable-pic --disable-neon --enable-asm"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/storage/Sabish/Iyan3D_6.0_SVN/Iyan3D/app/ffmpeg/install/x86/share/ffmpeg"
#define AVCONV_DATADIR "/storage/Sabish/Iyan3D_6.0_SVN/Iyan3D/app/ffmpeg/install/x86/share/ffmpeg"
