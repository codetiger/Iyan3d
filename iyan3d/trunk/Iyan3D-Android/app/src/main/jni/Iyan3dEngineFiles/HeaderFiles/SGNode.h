...
public:
    ...
    void setMeshProperties(int matIndex, float refraction, float reflection, bool isLighting, bool isVisible , bool isPhysicsObj, int physicsType, float fMagnitude, float currentFrame);
    void clearSGJoints();
    void createSGJoints();
