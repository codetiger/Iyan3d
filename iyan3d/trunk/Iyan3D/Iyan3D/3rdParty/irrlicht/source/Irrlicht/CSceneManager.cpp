	...
	IRR_XML_FORMAT_SCENE(L"irr_scene"), IRR_XML_FORMAT_NODE(L"node"), IRR_XML_FORMAT_NODE_ATTR_TYPE(L"type")
{
	...
	#endif
	#ifdef _IRR_COMPILE_WITH_SGM_LOADER_
		MeshLoaderList.push_back(new CSGMMeshFileLoader(this));
	#endif
	#ifdef _IRR_COMPILE_WITH_SGR_LOADER_
		MeshLoaderList.push_back(new CSGRMeshFileLoader(this));
	#endif
	#ifdef _IRR_COMPILE_WITH_SGP_LOADER_
		MeshLoaderList.push_back(new CSGPMeshFileLoader(this));
	#endif
