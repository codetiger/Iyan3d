...
void CIrrDeviceStub::enableKeyInput() {
		
}

void CIrrDeviceStub::disableKeyInput() {
		
}

void CIrrDeviceStub::setEAGLContext(void* context) {
}
	
void* CIrrDeviceStub::getEAGLContext() {
    return NULL;
}

	

core::position2di  CIrrDeviceStub::getWindowPosition(){
