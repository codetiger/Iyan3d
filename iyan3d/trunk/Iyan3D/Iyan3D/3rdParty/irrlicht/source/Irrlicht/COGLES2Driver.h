...
namespace video
{
	...
	public:
        ...
        virtual void removeShaderProgram(int materialIndex);
...
//					bool clearBackBuffer=true, bool clearZBuffer=true, SColor color=SColor(0,0,0,0));
		...
		virtual int getFrameBuffer();
		virtual int getRenderBuffer();
		virtual int getDepthInfoBuffer();
        core::array<GLuint> *shaderPrograms;
