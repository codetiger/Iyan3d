...
void CNullDriver::removeShaderProgram(int materialIndex){
...
int CNullDriver::getFrameBuffer(){
	return getFrameBuffer();
}
	
int CNullDriver::getRenderBuffer(){
	return	getRenderBuffer();
}
	
int CNullDriver::getDepthInfoBuffer(){
	return getDepthInfoBuffer();
}
