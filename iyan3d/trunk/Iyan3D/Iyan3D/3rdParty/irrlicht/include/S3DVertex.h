			...
			struct S3DVertex2TCoords : public S3DVertex
			{
				...
				bool operator==(const S3DVertex2TCoords& other) const
				{
					return ((static_cast<S3DVertex>(*this)==other) &&
							(TCoords2 == other.TCoords2 && Weight1 == other.Weight1 && Weight2 == other.Weight2 && bones1 == other.bones1 && bones2 == other.bones2));
				}
				...
				{
					return ((static_cast<S3DVertex>(*this) < other) ||
							((static_cast<S3DVertex>(*this) == other) && (TCoords2 < other.TCoords2 && Weight1 < other.Weight1 && Weight2 < other.Weight2 && bones1 < other.bones1 && bones2 < other.bones2)));
				}
